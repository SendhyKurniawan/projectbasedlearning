...
<x-app-layout>
 ...
 <span class="text-primary">Jurusan</span>
 </nav>
 <h1 class="font-headline text-3xl font-extrabold tracking-tight text-on-surface">Manajemen Jurusan</h1>
 <p class="mt-1 text-sm text-on-surface-variant">Daftar jurusan/fakultas pada institusi.</p>
 </div>
