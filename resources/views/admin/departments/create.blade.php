...
<x-app-layout>
 ...
 <span class="text-primary">Tambah Jurusan</span>
 </nav>
 <h1 class="font-headline text-3xl font-extrabold tracking-tight text-on-surface">Tambah Jurusan</h1>
 <p class="mt-1 text-sm text-on-surface-variant">Daftarkan jurusan baru pada struktur akademik.</p>
 </div>
