...
<x-app-layout>
 ...
 <h1 class="font-headline text-3xl font-extrabold tracking-tight text-on-surface">Edit Kelas</h1>
 <p class="mt-1 text-sm text-on-surface-variant">Perbarui informasi kelas mahasiswa.</p>
 </div>
