<x-app-layout>
 ...
 @csrf
 @method('DELETE')
 <button type="submit" class="text-error hover:text-red-700" onclick="return confirm('Apakah Anda yakin ingin menghapus kelas ini?')">Hapus</button>
 </form>
 </td>
 </tr>
 @empty
