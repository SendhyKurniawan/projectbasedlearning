<x-app-layout>
 ...
 @csrf
 @method('DELETE')
 <button type="submit" class="text-error hover:text-red-700" onclick="return confirm('Apakah Anda yakin ingin menghapus semester ini?')">Hapus</button>
 </form>
 </td>
 </tr>
 @endforeach
