...
<x-app-layout>
 ...
 <h1 class="font-headline text-3xl font-extrabold tracking-tight text-on-surface">Tambah Semester</h1>
 <p class="mt-1 text-sm text-on-surface-variant">Buat periode akademik baru pada tahun ajaran tertentu.</p>
 </div>
