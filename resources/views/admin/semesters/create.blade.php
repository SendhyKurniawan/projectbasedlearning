<x-app-layout>
 ...
 <input id="is_active" type="checkbox" class="rounded border-outline-variant/30 text-primary shadow-sm focus:ring-primary/20:ring-indigo-600:ring-offset-gray-800" name="is_active" {{ old('is_active') ? 'checked' : '' }}>
