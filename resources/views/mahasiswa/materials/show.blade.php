<x-app-layout>
 ...
 <!-- Course Info -->
 <div class="mb-4 pb-4 border-b border-surface-container-low">
 <h3 class="font-bold text-lg text-on-surface mb-1">
 {{ $course->nama_matkul }}
 </h3>
 <p class="text-xs text-on-surface-variant">{{ $course->kode_matkul }}</p>
 </div>
 ...
 {{ $isCurrent ? 'bg-blue-50 border-blue-500' : ($isCompleted ? 'bg-green-50 border-green-500 hover:bg-green-100:bg-green-900/20' : 'bg-surface-container-lowest border-surface-container-low hover:bg-surface-bright') }}">
 ...
 @else
 <div class="w-4 h-4 rounded-full border-2 border-outline-variant/30"></div>
 @endif
 </div>
 ...
 @else
 <div class="block p-3 rounded-lg bg-surface-container-low border-l-4 border-outline-variant/30 opacity-60">
 <div class="flex items-start gap-2">
 <div class="flex-shrink-0 mt-0.5">
 <svg class="w-4 h-4 text-outline" fill="currentColor" viewBox="0 0 20 20">
 ...
 <p class="text-sm font-medium text-on-surface-variant truncate">
 {{ Str::limit($item['item']->title, 50) }}
 </p>
 </div>
 </div>
 ...
 <div class="card mb-6">
 <h3 class="text-lg font-semibold mb-3 text-on-surface flex items-center gap-2">
 ...
 <button @click="fullscreen = !fullscreen" class="text-sm flex items-center gap-1 text-on-surface-variant hover:text-on-surface:text-white transition-colors">
 ...
 <div :class="{'fixed inset-0 z-[100] bg-gray-900/95 flex flex-col p-4': fullscreen, 'border rounded-lg overflow-hidden bg-surface-container-low ': !fullscreen}">
 ...
 <div class="mb-4 border rounded-lg overflow-hidden bg-surface-container-low flex justify-center p-4">
 ...
 target="_blank"
 class="px-5 py-2.5 architectural-gradient text-white text-sm font-bold rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/40 active:scale-[0.98] transition-all inline-flex items-center gap-2">
 ...
 @endphp
 <a href="{{ $prevUrl }}" 
 class="px-5 py-2.5 bg-surface-container-high text-on-surface-variant text-sm font-bold rounded-xl hover:bg-surface-container-highest transition-colors inline-flex items-center gap-2">
