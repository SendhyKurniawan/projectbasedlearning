<x-app-layout>
 ...
 <a href="{{ route('discussions.show', $discussion) }}" class="text-sm text-on-surface-variant hover:text-on-surface ">
 &larr; Kembali
 </a>
 </div>
 </x-slot>
 ...
 <textarea id="content" name="content" rows="6" class="block mt-1 w-full border-outline-variant/30 text-on-surface focus:border-indigo-500:border-indigo-600 focus:ring-primary/20:ring-indigo-600 rounded-md shadow-sm" required>{{ old('content', $discussion->content) }}</textarea>
