                ...
                <div class="p-6">
                    <form action="{{ route('dosen.exercises.store', $course) }}" method="POST" id="exercise-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <!-- Language -->
                            <div>
                                <label for="exercise_language" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
...
<body>
    <!-- TODO: Lengkapi kode di sini -->
                        ...
                        <div class="mb-4">
                            <label for="required_keywords" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <!-- Hints -->
                        <div class="mb-6">
                            <label for="hints" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
